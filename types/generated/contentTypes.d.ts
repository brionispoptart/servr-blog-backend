...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    code_snippets: Attribute.Relation<
      'api::article.article',
      'manyToMany',
    ...
    tags: Attribute.Relation<
      ...
      'api::tag.tag'
    >;
    Featured_Image: Attribute.Component<'media.image', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Social_Media: Attribute.JSON;
    Profile_image: Attribute.Component<'media.image'>;
...
export interface ApiImageImage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tags: Attribute.Relation<'api::image.image', 'manyToMany', 'api::tag.tag'>;
    Upload_Date: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiVideoVideo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tags: Attribute.Relation<'api::video.video', 'manyToMany', 'api::tag.tag'>;
    Publication_Date: Attribute.DateTime;
    Thumbnail: Attribute.Component<'media.image', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
